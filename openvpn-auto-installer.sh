...
# =============================================================================
# Script   : openvpn-auto-installer
# Author   : Alvin Jaison
# License  : MIT
# Copyright: (c) 2026 Alvin Jaison
# Description: Secure OpenVPN server installer for Debian, Ubuntu, CentOS,
#              Amazon Linux 2023, Fedora, Oracle Linux, Arch Linux,
...
# CLI Configuration
# =============================================================================
readonly SCRIPT_NAME="openvpn-auto-installer"
...
function installQuestions() {
	...
	log_prompt "The git repository is available at: https://github.com/alvinjaison/openvpn-auto-installer"
	...
	if [[ $APPROVE_IP =~ n ]]; then
		...
		if [[ $ENDPOINT_TYPE == "4" ]]; then
			log_prompt "Internal server IPv4 address (the interface OpenVPN will bind to):"
			log_prompt "Note: If this server is behind NAT (e.g. AWS/cloud), keep this private IP — you will be asked for the public IP next."
			read -rp "IPv4 address: " -e -i "$IP" IP
		else
			log_prompt "Internal server IPv6 address (the interface OpenVPN will bind to):"
	...
	log_prompt "See https://github.com/alvinjaison/openvpn-auto-installer#security for more details."
	log_menu ""
